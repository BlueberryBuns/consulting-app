...
urlpatterns = [
    ...
    path(f"{endpoint_name}/patient/visits/id/<slug:id>/", VisitPatientAPIView.as_view(), name="Retrive particular visit by PK"),
    path(f"{endpoint_name}/patient/visits/date/<slug:datelookup>/", VisitPatientAPIView.as_view(), name="List visit not based on date lookup"),
